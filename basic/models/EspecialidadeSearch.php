...
class EspecialidadeSearch extends Especialidade
{
    ...
    {
        return [
            [['especialidade_sigla', 'especialidade_descricao'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['ilike', 'especialidade_sigla', $this->especialidade_sigla])
            ->andFilterWhere(['ilike', 'especialidade_descricao', $this->especialidade_descricao]);
